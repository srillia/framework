package io.gaad.infrastructure.rpc.util;
                ...
                if (method.getGenericReturnType() instanceof ParameterizedType) {
                    ...
                    if (resultData != null) {
                        try {
                            ...
                            resultBean.setData(JSON.parseObject(JSON.toJSONString(resultData.toString()), resultGenericType[0]));
                        }
                    }
                }
                return resultBean;
                        ...
                        for (Object item : list) {
                            if (item != null) {
                                try {
                                    ...
                                    ret.add(JSON.parseObject(JSON.toJSONString(resultData.toString()), resultGenericType[0]));
                                }
                            }
                        }
