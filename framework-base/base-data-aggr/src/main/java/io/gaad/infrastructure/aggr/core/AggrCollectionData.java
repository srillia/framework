package io.gaad.infrastructure.aggr.core;


import io.gaad.infrastructure.aggr.util.AggrUtil;
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                if (slaveList instanceof Collection) {
                    mainList = AggrUtil
                        .copy(mainList, mainIdFiledNames, (Collection<?>) slaveList, slaveIdFileNames, slaveFileName);
                    continue;
                }
